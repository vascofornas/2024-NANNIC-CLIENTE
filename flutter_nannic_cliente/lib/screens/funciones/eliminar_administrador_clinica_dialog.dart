...
Future<dynamic> buildEliminarAdministradorClinicaDialog(BuildContext context,
    String? clinicaId,
      ...
      return AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text('quitaradministradorcentro'.tr(), style: AppFonts.nannic(
              color: Colors.white,
              fontWeight: FontWeight.w800,
              fontSize: 16
            )),
