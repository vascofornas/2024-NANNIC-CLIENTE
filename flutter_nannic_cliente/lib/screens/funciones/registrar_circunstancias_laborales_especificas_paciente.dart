...
Future<void> registrarCircunstanciasLaboralesEspecificasPaciente({
  required String idPaciente,
  required String valor,
  required String fechaActualizacion,
}) async {
  final url = Uri.parse(URLProyecto+APICarpeta+"registrar_circunstancias_laborales_especificas_paciente.php");
