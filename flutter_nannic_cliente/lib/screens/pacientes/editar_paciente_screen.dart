...
import 'package:flutter_nannic_cliente/screens/pacientes/editar_paciente_content.dart';
...
class EditarPacientePage extends StatefulWidget {
  const EditarPacientePage({Key? key, required this.paciente, }) : super(key: key);
...
class _EditarPacientePageState extends State<EditarPacientePage> {
  ...
  void initState() {
    ...
    print("datos del paciente recibidos en editar paciente page ${widget.paciente.imagen_paciente}");
  }
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      MiTextoSimple(texto: "datospaciente".tr(), color: Colors.grey, fontWeight: FontWeight.bold, fontsize: 20)
                    ],
                  ),
                  EditarPacienteContent(paciente: widget.paciente,),
                ],
              ),
            ),
          ),
