...
class EditEquipoContent extends StatefulWidget {
  const EditEquipoContent({Key? key, required this.equipo, required this.clinicaId}) : super(key: key);

  final Equipo equipo;
  final String clinicaId;

  @override
  State<EditEquipoContent> createState() => _EditEquipoContentState();
}

class _EditEquipoContentState extends State<EditEquipoContent> {
  ...
  Future<void> registrarEquipo() async {
    const String url =
        URLProyecto + APICarpeta + "actualizar_datos_equipo.php";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print("respuesta  equipo editado ${response.body}");

          Fluttertoast.showToast(
            msg: "edicionnuevodispositivo".tr(),
  ...
  void initState() {
    ...
    imagenEquipo = widget.equipo.imagen_equipo!;
    _nameController.text = widget.equipo.nombre_equipo!;
  }
