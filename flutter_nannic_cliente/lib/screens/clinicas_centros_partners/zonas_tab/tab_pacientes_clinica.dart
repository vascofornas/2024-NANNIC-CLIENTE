...
import 'package:flutter_nannic_cliente/screens/clinicas_centros_partners/zonas_tab/zona_pacientes/contenido_pacientes_clinica.dart';
...
class TabPacientesClinica extends StatefulWidget {
  const TabPacientesClinica({Key? key, required this.clinicaNombre, required this.clinicaEmail, required this.clinicaDireccion, required this.clinicaLogo, required this.clinicaPais, required this.clinicaTel, required this.clinicaId, }) : super(key: key);
  ...
  @override
  State<TabPacientesClinica> createState() => _TabPacientesClinicaState();
}

class _TabPacientesClinicaState extends State<TabPacientesClinica> {
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  ContenidoPacientesClinica(clinicaId: widget.clinicaId!, clinicaNombre: widget.clinicaNombre,),
                ],
              ),
            ),
          ),
