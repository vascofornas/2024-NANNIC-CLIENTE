...
class TabProfesionalesClinica extends StatefulWidget {
  const TabProfesionalesClinica({Key? key, required this.clinicaNombre, required this.clinicaEmail, required this.clinicaDireccion, required this.clinicaLogo, required this.clinicaPais, required this.clinicaTel, required this.clinicaId, }) : super(key: key);
  ...
  @override
  State<TabProfesionalesClinica> createState() => _TabProfesionalesClinicaState();
}

class _TabProfesionalesClinicaState extends State<TabProfesionalesClinica> {
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  ContenidoProfesionalesClinica(clinicaId: widget.clinicaId!, clinicaNombre: widget.clinicaNombre,),
                ],
              ),
            ),
          ),
