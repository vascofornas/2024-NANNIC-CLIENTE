...
class NuevoProfesionalClinicaContent extends StatefulWidget {
  const NuevoProfesionalClinicaContent({Key? key, required this.clinicaId, required this.clinicaNombre}) : super(key: key);
  final String clinicaId;
  final String clinicaNombre;

  @override
  State<NuevoProfesionalClinicaContent> createState() => _NuevoProfesionalClinicaContentState();
}

class _NuevoProfesionalClinicaContentState extends State<NuevoProfesionalClinicaContent> {
