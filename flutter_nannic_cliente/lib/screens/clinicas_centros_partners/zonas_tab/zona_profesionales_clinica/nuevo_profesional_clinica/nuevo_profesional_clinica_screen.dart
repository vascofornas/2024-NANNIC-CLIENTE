...
class NuevoProfesionalClinicaPage extends StatefulWidget {
  const NuevoProfesionalClinicaPage({Key? key, required this.clinicaId, required this.clinicaNombre}) : super(key: key);

  final String clinicaId;
  final String clinicaNombre;

  @override
  State<NuevoProfesionalClinicaPage> createState() => _NuevoProfesionalClinicaPageState();
}

class _NuevoProfesionalClinicaPageState extends State<NuevoProfesionalClinicaPage> {
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  NuevoProfesionalClinicaContent(clinicaId: widget.clinicaId,clinicaNombre: widget.clinicaNombre,),
                ],
              ),
            ),
          ),
